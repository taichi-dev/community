...
> IMPORTANT: Ensure that you run the voxel editor on Taichi Lang v1.0.0. An error may occur if you run it on v1.0.1. We plan on fixing the corresponding [issue](https://github.com/taichi-dev/taichi/issues/4891) in the next release. 
